defmodule Time2.JobsTest do
  ...
  describe "jobs" do
    ...
    @valid_attrs %{budget: 42, desc: "some desc", job_code: "some job_code", name: "some name"}
    @update_attrs %{budget: 43, desc: "some updated desc", job_code: "some updated job_code", name: "some updated name"}
    @invalid_attrs %{budget: nil, desc: nil, job_code: nil, name: nil}
